...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    jokes: Schema.Attribute.Relation<'manyToMany', 'api::joke.joke'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiVoteVote extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fingerprint: Schema.Attribute.String & Schema.Attribute.Private;
    ip_address: Schema.Attribute.String;
    joke: Schema.Attribute.Relation<'manyToOne', 'api::joke.joke'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value: Schema.Attribute.Enumeration<['up', 'down', 'neutral']> &
      Schema.Attribute.Required &
