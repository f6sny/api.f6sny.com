...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    biography: Attribute.String;
    safe_content_preference: Attribute.Enumeration<
...
export interface ApiJokeJoke extends Schema.CollectionType {
  ...
  attributes: {
    ...
    remarks: Attribute.Text & Attribute.Private;
    tags: Attribute.Relation<'api::joke.joke', 'manyToMany', 'api::tag.tag'>;
    votes: Attribute.Relation<'api::joke.joke', 'oneToMany', 'api::vote.vote'>;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    votes: Attribute.Relation<'api::page.page', 'oneToMany', 'api::vote.vote'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    jokes: Attribute.Relation<'api::tag.tag', 'manyToMany', 'api::joke.joke'>;
    safe_content_preference: Attribute.Enumeration<
      ['strict', 'moderate', 'open']
    > &
      Attribute.DefaultTo<'moderate'>;
...
export interface ApiVoteVote extends Schema.CollectionType {
  ...
  attributes: {
    value: Attribute.Enumeration<['up', 'down', 'neutral']> &
      Attribute.Required &
